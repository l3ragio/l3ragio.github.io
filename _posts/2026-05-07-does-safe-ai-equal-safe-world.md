...
BlueDot Technical AI Safety, [Unit 4 (Understanding AI)](https://bluedot.org/courses/technical-ai-safety/4), discussion group 03. The session was facilitated by **Caroline**; the structure of the unit - reflection, teach-each-other, debate, final reflection - is what produced the depth this post tries to capture, and her pacing of the closing reflection is where the framing of "diagnoses through interp findings have value even when they do not deliver guarantees" emerged.
